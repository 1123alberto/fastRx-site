...
const COPY = {
  gr: {
    ...
    "benefit-access": "Ερώτηση για πρόσβαση ή χρήση του FastRx",
    ...
    "reason-access": "Έχω ερώτηση για πρόσβαση ή χρήση", "reason-issue": "Αναφέρω πρόβλημα ή τεχνικό θέμα", "reason-feedback": "Έχω πρόταση ή σχόλιο", "reason-other": "Άλλο",
  ...
  en: {
    ...
    "benefit-access": "Questions about FastRx access or use",
    ...
    "reason-access": "I have a question about access or use", "reason-issue": "I am reporting a problem or technical issue", "reason-feedback": "I have feedback or a suggestion", "reason-other": "Other",
