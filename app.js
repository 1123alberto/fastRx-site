...
const COPY = {
  gr: {
    ...
    "step1-title": "Ταυτοποίηση Ασθενούς",
    "step1-text": "Γρήγορη εύρεση δημογραφικού προφίλ ασθενούς.",
    "step2-title": "Επιλογή Διάγνωσης ICD-10",
    "step2-text": "Έξυπνη αναζήτηση και φιλτράρισμα κλινικών κωδικών.",
    "step3-title": "Επιλογή Προτύπου Συνταγής",
    "step3-text": "Άμεση φόρτωση προσαρμοσμένων αγαπημένων σχημάτων.",
    "step4-title": "Έλεγχος Ιατρού",
    "step4-text": "Συγκεντρωτικός έλεγχος στοιχείων σε μία οθόνη.",
    "step5-title": "Έγκριση & Υποβολή",
...
function updateDOM() {
  ...
  if (labelGR && labelEN) {
    if (currentLang === 'gr') {
      labelGR.classList.add('active');
      labelEN.classList.remove('active');
    } else {
      labelGR.classList.remove('active');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (langBtn) {
    langBtn.addEventListener('click', () => {
      const nextLang = currentLang === 'gr' ? 'en' : 'gr';
