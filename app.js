...
const COPY = {
    ...
    "meta-description": "FastRx για ιατρούς: ηλεκτρονική συνταγογράφηση μέσω του Συστήματος Ηλεκτρονικής Συνταγογράφησης (ΣΗΣ), με εφαρμογή για κινητό και tablet και την επερχόμενη έκδοση FastRx Office για υπολογιστή.",
    "og:title": "FastRx | Ηλεκτρονική Συνταγογράφηση για Ιατρούς",
    "og:description": "Ηλεκτρονική συνταγογράφηση για ιατρούς μέσω του Συστήματος Ηλεκτρονικής Συνταγογράφησης (ΣΗΣ), με το FastRx για κινητό και tablet και την επερχόμενη έκδοση FastRx Office για υπολογιστή.",
    "twitter:title": "FastRx | Ηλεκτρονική Συνταγογράφηση για Ιατρούς",
    "twitter:description": "Ηλεκτρονική συνταγογράφηση για ιατρούς μέσω του Συστήματος Ηλεκτρονικής Συνταγογράφησης (ΣΗΣ), με το FastRx για κινητό και tablet και την επερχόμενη έκδοση FastRx Office για υπολογιστή.",
    "hero-badge": "ΕΠΙΣΗΜΗ ΙΣΤΟΣΕΛΙΔΑ",
    "hero-title": "Η ηλεκτρονική συνταγογράφηση στο κινητό, σε μια καθαρή και γρήγορη ροή.",
    "hero-subtitle": "Το FastRx είναι εργαλείο κλινικής ροής για ιατρούς. Συνδέει τα βασικά βήματα της ηλεκτρονικής συνταγογράφησης και υποστηρίζει επιλεγμένες λειτουργίες μέσω των επίσημων υπηρεσιών του Συστήματος Ηλεκτρονικής Συνταγογράφησης (ΣΗΣ), το οποίο λειτουργεί και συντηρεί η ΗΔΥΚΑ.",
    "hero-cta": "Είσοδος στο FastRx",
    "hero-secondary-cta": "Ζητήστε πρόσβαση",
    "hero-access-note": "Η πρόσβαση στο FastRx παρέχεται προς το παρόν σε ιατρούς με ενεργή πρόσβαση στο FastRx. Η σύνδεση στο ΣΗΣ είναι απαραίτητη για τις λειτουργίες συνταγογράφησης, αλλά δεν παρέχει από μόνη της πρόσβαση στο FastRx. Αν ενδιαφέρεστε να χρησιμοποιήσετε το FastRx, μπορείτε να ζητήσετε πρόσβαση μέσω της φόρμας επικοινωνίας.",
    "office-badge": "ΕΡΧΕΤΑΙ ΣΥΝΤΟΜΑ",
    "office-kicker": "Η επόμενη έκδοση της οικογένειας FastRx",
    "office-title": "FastRx Office",
    "office-lead": "Η έκδοση του FastRx για τον υπολογιστή.",
    "office-text": "Ένα ειδικά σχεδιασμένο περιβάλλον εργασίας για ιατρούς που συνταγογραφούν κυρίως από σταθερό υπολογιστή, με τα βασικά στοιχεία ασθενούς, διάγνωσης και συνταγής συγκεντρωμένα σε ένα ενιαίο workspace.",
    "office-note": "Στόχος είναι μια ταχύτερη ροή με λιγότερη πλοήγηση — όχι απλώς το υπάρχον FastRx σε μεγαλύτερη οθόνη.",
    "problem-title": "Τι κάνει το FastRx;",
    "problem-text": "Το FastRx οργανώνει την καθημερινή ηλεκτρονική συνταγογράφηση σε μία συνεχή ροή: σύνδεση στο ΣΗΣ, αναζήτηση ασθενούς, επιλογή μονάδας συνταγογράφησης όπου απαιτείται, ενεργή επίσκεψη, ICD-10, αναζήτηση φαρμάκων, προετοιμασία, τελικό έλεγχο και υποστηριζόμενη υποβολή στο ΣΗΣ. Ο ιατρός διατηρεί τον πλήρη έλεγχο των κλινικών επιλογών.",
    ...
    "step5-title": "Υποβολή στο ΣΗΣ",
    "step5-text": "Υποστηριζόμενη ολοκλήρωση της συνταγής στο ΣΗΣ, μετά από επιβεβαίωση του ιατρού.",
    "capabilities-title": "Εργαλεία ηλεκτρονικής συνταγογράφησης για ιατρούς",
    ...
    "sync-main-text": "<p>Το FastRx Sync είναι προαιρετικό και ξεχωριστό από την κλινική υποβολή στο ΣΗΣ.</p><p>Μπορεί να συγχρονίζει υποστηριζόμενα δεδομένα επιπέδου λογαριασμού, όπως αγαπημένα, προτιμήσεις και δομημένα πρότυπα, μεταξύ υποστηριζόμενων εγκαταστάσεων.</p>",
    ...
    "status-card-title": "FastRx, ΣΗΣ και κλινική ευθύνη",
    "status-main-text": "<p>Το FastRx υποστηρίζει τη ροή εργασίας και χρησιμοποιεί τις επίσημες υπηρεσίες του ΣΗΣ για τις λειτουργίες που υποστηρίζονται.</p><p>Δεν λαμβάνει ανεξάρτητες κλινικές αποφάσεις και δεν επιλέγει διάγνωση, φάρμακο ή εξέταση αντί του ιατρού.</p>",
    ...
    "benefit-access": "Θέλω να ζητήσω πρόσβαση στο FastRx",
    "benefit-issue": "Αναφορά προβλήματος ή τεχνικού θέματος",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (privacyModal) {
    ...
    document.addEventListener('keydown', e => { if (e.key === 'Escape' && privacyModal.classList.contains('open')) closeModal(); });
  }
});
